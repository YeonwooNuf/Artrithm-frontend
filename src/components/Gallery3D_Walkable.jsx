    ...
    <div className="absolute inset-0 w-full h-full z-0">
      <Canvas shadows camera={{ fov: 35, position: [-8, 2, 18] }}>
        ...
        <Physics gravity={[0, -9.81, 0]}>
          ...
          {/* 그림들 */}
          <Painting position={[-5, 1.5, 2]} imageUrl="/art1.png" title="작품 1" />
          <Painting position={[0, 1.5, 2]} imageUrl="/art2.jpeg" title="작품 2" />
          <Painting position={[5, 1.5, 2]} imageUrl="/art3.jpeg" title="작품 3" />
        </Physics>
      </Canvas>
